...
import {Text, Button, useDisclosure, Input, Stack, Center, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody, DrawerFooter, Box} from "@chakra-ui/react";
              ...
              <Stack>
                {studentData ? (
                  ...
                  <AsyncSelect
                    ...
                    onChange={(e) => {
                      setCreatePaymentData({...createPaymentData, person: e.value});
                    }}
                  />
                )}
